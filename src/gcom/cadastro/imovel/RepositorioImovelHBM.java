	...
	public Imovel pesquisarImovel(Integer idImovel) throws ErroRepositorioException {
		...
		try {
			...
			consulta.append("SELECT imov FROM Imovel imov ")
				...
				.append(" LEFT JOIN FETCH imov.clienteImoveis clienteImoveis ")
				.append(" LEFT JOIN FETCH clienteImoveis.cliente cliente ")
				.append(" LEFT JOIN FETCH cliente.clienteTipo clienteTipo ")
				.append(" LEFT JOIN FETCH clienteTipo.esferaPoder esferaPoder ")
